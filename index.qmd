...
![Ducks!](images/duck_family.JPG){fig-alt="A duck family swimming on a lake" style="float: left; margin-right: 20px; margin-bottom: 10px; border-radius: 8px;" width="350"} ![](images/Ibis_feeding.JPG){fig-alt="American White Ibis feeding in a wetland" style="float: left; margin-right: 20px; margin-bottom: 10px; border-radius: 8px;" width="350"} ![](images/bearprint-gps.JPG){fig-alt="A bear print in mud with a GPS device for scale" style="float: left; margin-right: 20px; margin-bottom: 10px; border-radius: 8px;" width="350"} ![](images/mooseprint.jpg){style="float: left; margin-right: 20px; margin-bottom: 10px; border-radius: 8px;" fig-alt="A moose track in dirt with a hand for scale" width="350"}
